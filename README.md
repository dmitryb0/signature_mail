...
<head>
    ...
    <title>Подготовка подписи</title>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                <ul class="navbar-nav text-light" id="accordionSidebar" style="height: 118px;margin-top: 20px;">
                    <li class="nav-item"><a class="nav-link active" href="index.html"><i class="fa fa-envelope-o" style="padding-right: 10px;"></i><span><strong>Подпись</strong><br></span></a></li>
                    <li class="nav-item"><a class="nav-link" href="thunderbirt.html"><i class="fa fa-envelope-o" style="padding-right: 10px;"></i><span><strong>Thunderbird</strong></span></a></li>
